...
import mdp
from PatchNormalization import NormalizePatchNode
...
def createSFANetwork():
    ...
    normalizeNode = NormalizePatchNode(input_dim=switchboard.out_channel_dim)
    flowNode = mdp.hinet.FlowNode(normalizeNode + sfa1 + quadraticExpansion + sfa2) #
    ...
    sfaNet = mdp.Flow([switchboard, inputLayer, switchboard2, middleLayer, switchboard3, middleLayer2, outputLayer], verbose=True)
    return sfaNet
